export function buildPromptForMessage({ mensagem, empreendimentos }) {
	...
	return [
		...
		"- 5) Se nenhum item casar por nome ou bairro, responda apenas pedindo as referências com: 'Olá 👋, Para eu te direcionar com precisão, me diga, por favor, o nome do empreendimento ou o bairro com a tipologia (ex: studio, 2q, 3q, 4q, Lote). Assim, consigo te apresentar as opções mais adequadas dos empreendimentos. Atuo apenas com os empreendimentos da base, mas posso te indicar opções nela. 😊'",
		"- 6) Comentários fora de imóveis (economia, política, juros, incertezas): responda com empatia breve e retome pedindo nome/bairro/tipologia, reforçando que atua apenas com os empreendimentos da base.",
...
export default buildPromptForMessage;
